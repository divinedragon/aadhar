...
<%
    String PAGE_TITLE = ":: Aadhar :: Edit Service Provider";
    String MENU_NAME  = "Service Providers";
    String LINK_NAME  = "Modify";
%>
...
<div id="page-heading"><h1>Edit Service Provider</h1></div>
...
<tr>
    ...
    <tr valign="top">
    <td>
        <form:form id="serviceProviderForm" method="post" action="edit" modelAttribute="editServiceProvider">
